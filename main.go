...
import (
	...
	"github.com/zshipu/go-gin-example/pkg/gredis"
...
// @termsOfService https://github.com/zshipu/go-gin-example
// @license.name MIT
// @license.url https://github.com/zshipu/go-gin-example/blob/master/LICENSE
func main() {
